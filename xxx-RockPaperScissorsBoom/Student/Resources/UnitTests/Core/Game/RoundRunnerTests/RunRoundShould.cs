...
namespace UnitTests.Core.Game.RoundRunnerTests
{
    public class RunRoundShould
    {
        ...
        {
            RoundResult roundResult = RoundRunner.RunRound(_rockOnlyBot, _scissorsOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
        ...
        {
            RoundResult roundResult = RoundRunner.RunRound(_rockOnlyBot, _rockOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
        ...
        {
            RoundResult rockWin = RoundRunner.RunRound(_rockOnlyBot, _scissorsOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
            rockWin.Winner.Should().Be(_rockOnlyBot.Competitor);

            RoundResult paperWin = RoundRunner.RunRound(_paperOnlyBot, _rockOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
            paperWin.Winner.Should().Be(_paperOnlyBot.Competitor);

            RoundResult scissorsWin = RoundRunner.RunRound(_scissorsOnlyBot, _paperOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
            scissorsWin.Winner.Should().Be(_scissorsOnlyBot.Competitor);

            RoundResult dynamiteWin = RoundRunner.RunRound(_dynamiteOnlyBot, _rockOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
            dynamiteWin.Winner.Should().Be(_dynamiteOnlyBot.Competitor);

            RoundResult waterWin = RoundRunner.RunRound(_waterOnlyBot, _dynamiteOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
        ...
        public void IncrementDyanmite_GivenOneDynamiteUsage()
        {
            ...
            RoundRunner.RunRound(_dynamiteOnlyBot, _rockOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
        ...
        {
            int previousUsage = _dynamiteOnlyBot.DynamiteUsed;
            RoundRunner.RunRound(_dynamiteOnlyBot, _dynamiteOnlyBot, _builder.WithDefaults().Build(), new FakeMetrics());
        ...
        public void IncrementDyanmite_EvenWhenInvalid()
        {
            ...
            RoundRunner.RunRound(_dynamiteOnlyBot, fakeBot, _builder.WithDefaults().Build(), new FakeMetrics());
            _dynamiteOnlyBot.DynamiteUsed.Should().Be(previousUsage + 1);
